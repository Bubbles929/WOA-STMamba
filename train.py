...
def main():
    ...
    if cfg.model_name == 'RNN':
        ...
        # net = models.gMamba(input_size=cfg.input_size, in_channels=cfg.in_channels, out_in_channels=cfg.out_in_channels, output_size=cfg.output_size,d_state=cfg.d_state, d_conv=cfg.d_conv, expand=cfg.expand)
